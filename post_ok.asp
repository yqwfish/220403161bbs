      ...
      <tr>
        <td><div align="center"><!-- InstanceBeginEditable name="table" -->
          <table width="800" border="1" cellspacing="0" cellpadding="10">
            <tr>
              <th bgcolor="#CCFFCC"><div align="center">操作成功信息</div></th>
            </tr>
            <tr>
              <td bgcolor="#FFFFFF"><div align="center">
                <p>您的操作已经<strong>成功</strong>!</p>
                <p>                    <span class="style1">2</span> 秒钟后将自动转到<a href="/default1.asp"><strong>论坛首页</strong></a>!</p>
