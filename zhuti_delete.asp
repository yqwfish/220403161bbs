...
%>
<%
var delzhuti__MMColParam = "1";
if (String(Request.QueryString("ID")) != "undefined" && 
    String(Request.QueryString("ID")) != "") { 
  delzhuti__MMColParam = String(Request.QueryString("ID"));
}
%>
<%
var delzhuti = Server.CreateObject("ADODB.Recordset");
delzhuti.ActiveConnection = MM_luntan_STRING;
delzhuti.Source = "SELECT * FROM zhuti WHERE ID = "+ delzhuti__MMColParam.replace(/'/g, "''") + "";
delzhuti.CursorType = 0;
delzhuti.CursorLocation = 2;
delzhuti.LockType = 1;
delzhuti.Open();
var delzhuti_numRows = 0;
%>
<%
...
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
  <div align="center">
    <div align="center">
      ...
      <table width="800" height="30" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td nowrap><div align="left"><a href="/default1.asp">欢迎来到&quot;王国之心:记忆之链&quot;<strong>游戏论坛</strong>!</a> → <a href="/show1_delete.asp?ID=&num=">删除主题留言</a></div></td>
        ...
        <tr>
          <td><div align="center">
              <table width="800" height="190" border="1" cellpadding="10" cellspacing="0">
                <tr bgcolor="#CCFFCC">
                  <th colspan="2"><div align="center">删除主题留言</div></th>
                </tr>
                <tr bgcolor="#FFFFCC">
                  <td width="200"><div align="left">作者名称:</div></td>
                  <td width="554"><div align="left">
<label><%=(delzhuti.Fields.Item("user").Value)%></label>
</div></td>
                </tr>
                <tr bgcolor="#FFFFCC">
                  ...
                  <td><div align="left">
                    <p>
                      ...
                      <%=(delzhuti.Fields.Item("state").Value)%><br>
                    </p>
</div></td>
                </tr>
                <tr bgcolor="#FFFFCC">
                  <td><div align="left">主题标题:</div></td>
                  <td><div align="left"><%=(delzhuti.Fields.Item("title").Value)%>
                  </div></td>
                </tr>
                <tr bgcolor="#FFFFCC">
                  <td><div align="left">留言内容:</div></td>
                  <td><div align="left"><%=(delzhuti.Fields.Item("content").Value)%>
                  </div></td>
                </tr>
                <tr bgcolor="#FFFFCC">
  ...
  <input type="hidden" name="MM_recordId" value="<%= delzhuti.Fields.Item("ID").Value %>">
</form>
</body>
</html>
<%
