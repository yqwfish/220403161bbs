  ...
  <form name="form1" method="post" action="">
    ...
    <table width="800" height="30" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td><div align="right"><!-- InstanceBeginEditable name="lianjie" --><!-- InstanceEndEditable --> | <a href="lianxi.htm">联系我们</a> | </div></td>
      </tr>
    </table>
    <hr width="800">
    <table width="800" height="30" border="0" cellpadding="0" cellspacing="0">
          ...
          <table width="800" border="1" cellspacing="0" cellpadding="10">
            ...
            <tr>
              <td bgcolor="#FFFFFF"><div align="center">
                  <p><strong>对不起</strong>,您的操作已经<strong>失败</strong>!</p>
                  <p> <span class="style1">3</span> 秒钟后自动返回<a href="/default1.asp"><strong>论坛首页</strong></a>!</p>
