...
<meta http-equiv="refresh" content="3;URL=/guest_register.asp">
<!-- InstanceEndEditable -->
</head>
          ...
          <table width="800" border="1" cellspacing="0" cellpadding="10">
            ...
            <tr>
              <td bgcolor="#FFFFFF"><div align="center">
                  <p><strong>对不起</strong>,您输入的<strong>用户名已存在</strong>!</p>
                  <p> <span class="style1">3</span> 秒钟后将自动返回 <strong><a href="/guest_register.asp">注册新用户</a></strong> 页面!</p>
