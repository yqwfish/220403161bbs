...
var MM_authFailedURL="/default.asp";
  ...
  <div align="center">
    <div align="center">
      ...
      <table width="800" height="30" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <th><div align="left">| 主题留言数:<span class="style2"><%=(jiaoliou_total)%></span></div></th>
          <td><div align="right"> <%=String(Session("MM_Username"))%>:
          <% if (user.Fields.Item("admin").Value == "1"){ %>| <a href="/user_manage.asp">用户管理</a>          <% } %>| <a href="/user.asp">个人信息</a> | <a href="/guest_input.asp">发表主题</a> | <a href="lianxi.htm">联系我们</a>  | <a href="<%= MM_Logout %>">注销用户</a> | </div></td>
        </tr>
      </table>
      <hr width="800">
      <table width="800" height="30" border="0" cellpadding="0" cellspacing="0">
          ...
          <td><div align="center">
              <table width="800" height="85" border="1" cellpadding="10" cellspacing="0" bordercolor="#999999">
                <tr>
                  ...
                  <th height="20" bgcolor="#CCFFFF"><div align="center">发言主题</div></th>
                  <th width="100" height="20" bgcolor="#FFFFFF"><div align="center">作者</div></th>
                  <th width="200" bgcolor="#CCFFFF">发言时间</th>
                  <th width="40" height="20" bgcolor="#FFFFFF"><div align="center">
                ...
                <tr>
                  ...
                  <td height="30" nowrap bgcolor="#CCFFFF"><div align="left"><a href="/show1.asp?ID=<%=(gonggao.Fields.Item("ID").Value)%>"><%=(gonggao.Fields.Item("title").Value)%></a></div></td>
                  <td width="100" height="30" bgcolor="#FFFFFF"><div align="center"><%=(gonggao.Fields.Item("user").Value)%></div></td>
                  <td width="200" bgcolor="#CCFFFF"><div align="center"><%=(gonggao.Fields.Item("date").Value)%> | <%=(gonggao.Fields.Item("time").Value)%></div></td>
                  <td height="30" bgcolor="#FFFFFF"><div align="center"><a href="/zhuti_delete.asp?ID=<%=(gonggao.Fields.Item("ID").Value)%>">
</a><a href="/zhuti_delete.asp?ID=<%=(gonggao.Fields.Item("ID").Value)%>">
<% if (user.Fields.Item("admin").Value == "1"){ %>
</a><a href="/zhuti_delete.asp?ID=<%=(gonggao.Fields.Item("ID").Value)%>">                    删除</a>
                      <% } %>
                  </div></td>
                </tr>
                <%
...
%>
        ...
        <tr>
          ...
          <td height="30" nowrap bgcolor="#CCFFFF"><div align="left"><a href="/show1.asp?ID=<%=(jiaoliou.Fields.Item("ID").Value)%>"><%=(jiaoliou.Fields.Item("title").Value)%></a></div></td>
          <td width="100" height="30" bgcolor="#FFFFFF"><div align="center"><%=(jiaoliou.Fields.Item("user").Value)%> </div></td>
          <td width="200" bgcolor="#CCFFFF"><div align="center"><%=(jiaoliou.Fields.Item("date").Value)%> | <%=(jiaoliou.Fields.Item("time").Value)%> </div></td>
          <td width="40" height="30" bgcolor="#FFFFFF"><div align="center"><a href="/zhuti_delete.asp?ID=<%=(jiaoliou.Fields.Item("ID").Value)%>">
            <% if (user.Fields.Item("admin").Value == "1"){ %>
          删除</a>
              <% } %>
          </div></td>
