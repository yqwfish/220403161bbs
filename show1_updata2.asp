...
if (String(Request("MM_update")) == "form1" &&
  ...
  var MM_editColumn = "num";
  var MM_recordId = "" + Request.Form("MM_recordId") + "";
  var MM_editRedirectUrl = "/post_ok.asp";
  var MM_fieldsStr = "content|value";
  var MM_columnsStr = "reple|',none,''";
...
if (String(Request.QueryString("num")) != "undefined" && 
    String(Request.QueryString("num")) != "") { 
  xiougai__MMColParam = String(Request.QueryString("num"));
}
%>
<%
var xiougai = Server.CreateObject("ADODB.Recordset");
xiougai.ActiveConnection = MM_luntan_STRING;
xiougai.Source = "SELECT * FROM huifu WHERE num = "+ xiougai__MMColParam.replace(/'/g, "''") + "";
...
%>
<%
var xiougaizhuti__MMColParam = "1";
if (String(Request.QueryString("ID")) != "undefined" && 
    String(Request.QueryString("ID")) != "") { 
  xiougaizhuti__MMColParam = String(Request.QueryString("ID"));
}
%>
<%
var xiougaizhuti = Server.CreateObject("ADODB.Recordset");
xiougaizhuti.ActiveConnection = MM_luntan_STRING;
xiougaizhuti.Source = "SELECT * FROM zhuti WHERE ID = "+ xiougaizhuti__MMColParam.replace(/'/g, "''") + "";
xiougaizhuti.CursorType = 0;
xiougaizhuti.CursorLocation = 2;
xiougaizhuti.LockType = 1;
xiougaizhuti.Open();
var xiougaizhuti_numRows = 0;
%>
<%
...
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
  <div align="center">
    <div align="center">
      ...
      <table width="800" height="30" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td nowrap><div align="left"><a href="/default1.asp">欢迎来到&quot;王国之心:记忆之链&quot;<strong>游戏论坛</strong>!</a> → <a href="/show1_updata2.asp?ID=<%=(xiougaizhuti.Fields.Item("ID").Value)%>&num=<%=(xiougai.Fields.Item("num").Value)%>">修改回复留言 </a></div></td>
        ...
        <tr>
          <td><div align="center">
              <table width="800" height="190" border="1" cellpadding="10" cellspacing="0">
                <tr bgcolor="#CCFFCC">
                  <th colspan="2"><div align="center">修改回复留言</div></th>
                </tr>
                <tr bgcolor="#FFFFCC">
                  <td width="200"><div align="left">回复人名称:</div></td>
                  <td width="554"><div align="left">
<label><%=(xiougai.Fields.Item("user").Value)%></label>
</div></td>
                </tr>
                <tr bgcolor="#FFFFCC">
                  <td><div align="left">主题留言状态:</div></td>
                  <td><div align="left">
                    <p>
                      <label>
</label>
                      <%=(xiougaizhuti.Fields.Item("state").Value)%><br>
                    </p>
</div></td>
                </tr>
                <tr bgcolor="#FFFFCC">
                  <td><div align="left">主题留言标题:</div></td>
                  <td><div align="left"><%=(xiougaizhuti.Fields.Item("title").Value)%>
                  </div></td>
                </tr>
                <tr bgcolor="#FFFFCC">
                  <td><div align="left">回复留言内容:</div></td>
                  <td><div align="left">
                      <textarea name="content" cols="60" rows="6" id="content"><%=(xiougai.Fields.Item("reple").Value)%></textarea>
                  </div></td>
                </tr>
                <tr bgcolor="#FFFFCC">
  ...
  <input type="hidden" name="MM_recordId" value="<%= xiougai.Fields.Item("num").Value %>">
</form>
</body>
</html>
<%
