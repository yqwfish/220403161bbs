...
if (String(Request.QueryString("num")) != "undefined" && 
  ...
  huifu__MMColParam = String(Request.QueryString("num"));
}
%>
<%
var huifu = Server.CreateObject("ADODB.Recordset");
huifu.ActiveConnection = MM_luntan_STRING;
huifu.Source = "SELECT * FROM huifu WHERE num = "+ huifu__MMColParam.replace(/'/g, "''") + "";
huifu.CursorType = 0;
...
%>
<%
var huifuzhuti__MMColParam = "1";
if (String(Request.QueryString("ID")) != "undefined" && 
    String(Request.QueryString("ID")) != "") { 
  huifuzhuti__MMColParam = String(Request.QueryString("ID"));
}
%>
<%
var huifuzhuti = Server.CreateObject("ADODB.Recordset");
huifuzhuti.ActiveConnection = MM_luntan_STRING;
huifuzhuti.Source = "SELECT * FROM zhuti WHERE ID = "+ huifuzhuti__MMColParam.replace(/'/g, "''") + "";
huifuzhuti.CursorType = 0;
huifuzhuti.CursorLocation = 2;
huifuzhuti.LockType = 1;
huifuzhuti.Open();
var huifuzhuti_numRows = 0;
%>
<%
...
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
  <div align="center">
    <div align="center">
      ...
      <table width="800" height="30" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td nowrap><div align="left"><a href="/default1.asp">欢迎来到&quot;王国之心:记忆之链&quot;<strong>游戏论坛</strong>!</a> → <a href="/show1_delete.asp?ID=<%=(huifuzhuti.Fields.Item("ID").Value)%>&num=<%=(huifu.Fields.Item("num").Value)%>">删除回复留言</a></div></td>
        ...
        <tr>
          <td><div align="center">
              <table width="800" height="190" border="1" cellpadding="10" cellspacing="0">
                <tr bgcolor="#CCFFCC">
                  <th colspan="2"><div align="center">删除回复留言</div></th>
                </tr>
                <tr bgcolor="#FFFFCC">
                  <td width="200"><div align="left">回复人名称:</div></td>
                  <td width="554"><div align="left">
<label><%=(huifu.Fields.Item("user").Value)%></label>
</div></td>
                </tr>
                <tr bgcolor="#FFFFCC">
                  ...
                  <td><div align="left">
                    <p>
                      ...
                      <%=(huifuzhuti.Fields.Item("state").Value)%><br>
                    </p>
</div></td>
                </tr>
                <tr bgcolor="#FFFFCC">
                  <td><div align="left">主题留言标题:</div></td>
                  <td><div align="left"><%=(huifuzhuti.Fields.Item("title").Value)%>
                  </div></td>
                </tr>
                <tr bgcolor="#FFFFCC">
                  <td><div align="left">回复留言内容:</div></td>
                  <td><div align="left"><%=(huifu.Fields.Item("reple").Value)%>
                  </div></td>
                </tr>
                <tr bgcolor="#FFFFCC">
                  <td colspan="2"><div align="center">
                      <table width="600" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="150"><div align="center"><a href="/default1.asp">取消</a>
                          </div></td>
                          <td width="150"><div align="center"></div></td>
                        </tr>
                      </table>
  ...
  <input type="hidden" name="MM_recordId" value="<%= huifu.Fields.Item("num").Value %>">
</form>
</body>
</html>
<%
